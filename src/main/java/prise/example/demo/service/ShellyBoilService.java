...
@Service
public class ShellyBoilService {

    private static final Logger logger = LoggerFactory.getLogger(ShellyBoilService.class);

    @Autowired
    private ShellyBoilDataRepository shellyBoilDataRepository;

    private static final String API_URL = "https://shelly-106-eu.shelly.cloud/device/status/?id=543204508608&auth_key=MjRiNjYwdWlk571844EF8698B132529C85123EF715DC4F355B8BFD47E4FDB6A2BF53A0B5614E61544A67E40B906D";
    ...
    public void fetchData() {
        try {
            ...
            ShellyBoilData data = new ShellyBoilData();
            ...
            shellyBoilDataRepository.save(data);
